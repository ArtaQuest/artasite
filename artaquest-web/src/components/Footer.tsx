...
const SOCIALS: { label: string; href: string; path: string; viewBox?: string }[] = [
  ...
  { label: "X", href: "https://x.com/arta_quest", path: "M18.9 1.15h3.68l-8.04 9.19L24 22.85h-7.4l-5.8-7.58-6.64 7.58H.48l8.6-9.83L0 1.15h7.59l5.24 6.93 6.07-6.93zm-1.29 19.5h2.04L6.48 3.24H4.29L17.61 20.65z" },
