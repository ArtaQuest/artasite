...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Does ArtaQuest have charitable status for tax receipts?", a: "Not yet. We are a registered non-profit but have not yet obtained charitable registration from the Canada Revenue Agency (CRA). We are working toward it and will notify all donors when official tax receipts become available." },
    ],
  },
];
