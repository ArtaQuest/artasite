...
const SECTIONS: Section[] = [
  {
    ...
    items: [
      ...
      { q: "Why a Kaggle notebook and a DOI as well?", a: "The kernel is the provenance: public code, public inputs, and a public run anyone can repeat without asking us for anything. The DOI is the citation of record, because a kernel belongs to its owner and can be edited or deleted at any time, and a DOI cannot." },
  ...
  },
  {
    ...
    items: [
      { q: "How do challenges work?", a: "A challenge is a tournament founded by a member: pick a sitewide topic and a full-moon deadline, set the entry fee, and open it with your own published work — the founder pays in like everyone else. Every entrant's fee goes straight into the pool, and at the full moon the most-hearted entry takes the whole pool; an exact tie splits it evenly. The Foundation never takes a cut." },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "What is Arta Coin (₳)?", a: "Arta Coin (₳) is ArtaQuest's currency. Each coin is backed one-for-one by a milligram of real gold held in full reserve, so it is worth the same in every country. You win coins by taking challenge pools, and you can buy or cash them out at the live gold rate from your Wallet." },
      ...
      { q: "What can I do with Arta Coins?", a: "Found or enter challenges, donate them to the member fund (which also earns you donor points), or cash them out for fiat at the live gold rate from your Wallet. Every coin is one milligram of gold held in full reserve." },
      { q: "Can I get a tax receipt?", a: "Every donation triggers an email confirmation that doubles as a record. For gifts above CAD 500 we issue a formal receipt on letterhead — email support@artaquest.org with your order number." },
  ...
  },
  {
    ...
    items: [
      { q: "What is a bursary for?", a: "Challenge entries cost gold-backed coins, and we never want cost to bar anyone from competing. Through the Sponsors programme, donors earmark Arta Coins to a community, and bursaries draw on that fund to cover entry fees for members in low-income or underserved groups — so the door stays open without a blanket free tier. Applying takes about five minutes." },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Where does ArtaQuest's funding come from?", a: "Donations from independent individuals, plus the small spread on buying and selling coins. Submitting, checking and publishing are all free, and challenge pools are never touched: 100% of entry fees returns to the winning entrants. We deliberately do not accept money from religious organisations, governments, corporate sponsors, tech and AI companies, political organisations, or agenda-driven foundations. Every coin is gold-backed and fully accounted for: see the live Reserve and the open ledgers." },
      { q: "Does ArtaQuest have charitable status for tax receipts?", a: "Not yet. We are a registered non-profit but have not yet obtained CRA charitable registration. We are working toward it and will notify all donors when official tax receipts become available." },
    ],
  },
];
