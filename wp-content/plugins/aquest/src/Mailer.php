...
class Mailer {
	...
	const TEMPLATES = [
		...
		'usage_invoice' => [
			...
			'audience'  => 'member',
			'subject'   => 'Your ArtaQuest day: {{total}} ArtaCoin',
			'body'      => "Hello {{name}},\n\nHere is your work on ArtaQuest on {{day}} — {{items}} item(s), about \${{usd}}.\n\n{{summary}}\n\n{{table}}\nYou are charged only for what actually ran, from the compute it really used and the gold price at the time. Nothing is estimated or held in advance.\n\nOne ArtaCoin is one milligram of gold, and gold does not come in fractions of a milligram — so usage adds up exactly, only whole coins are taken, and the remaining {{carry}} is carried to tomorrow rather than rounded away.\n\nIf a charge looks wrong, reply to this email and we will look at it with you.",
			// Two code-built blocks: the three figures that matter, and the day itself as a table. Both
			// are assembled in Usage.php from escaped values — never from anything a member typed.
			'html_vars' => [ 'summary', 'table' ],
			'cta'       => [ 'See every charge', '/user-account/' ],
			'vars'      => [ 'name', 'day', 'summary', 'table', 'items', 'total', 'usd', 'charged', 'carry' ],
			'sample'    => [
				'name' => 'Arash', 'day' => 'Sunday 9 August', 'items' => '3', 'total' => '10.6515', 'usd' => '1.49',
				'charged' => '10', 'carry' => '0.6515',
				'summary' => '<table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="margin:2px 0 18px"><tr><td width="33%" style="padding:0 6px 0 0"><div style="background:#f6f8fb;border-radius:10px;padding:12px 14px"><div style="font-size:20px;font-weight:700;color:#1746DC">10.6515 &#8371;</div><div style="font-size:12px;color:#8a97a6;margin-top:2px">used today</div></div></td><td width="33%" style="padding:0 6px 0 0"><div style="background:#f6f8fb;border-radius:10px;padding:12px 14px"><div style="font-size:20px;font-weight:700;color:#1f2a37">10 &#8371;</div><div style="font-size:12px;color:#8a97a6;margin-top:2px">charged, in whole coins</div></div></td><td width="33%"><div style="background:#f6f8fb;border-radius:10px;padding:12px 14px"><div style="font-size:20px;font-weight:700;color:#1f2a37">99.00 &#8371;</div><div style="font-size:12px;color:#8a97a6;margin-top:2px">balance now</div></div></td></tr></table>',
				'table'   => '<table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="margin:0 0 18px;border-collapse:collapse"><tr><th style="padding:0 8px 6px 0;font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:.04em;color:#8a97a6;text-align:left">What you asked</th><th style="padding:0 8px 6px 0;font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:.04em;color:#8a97a6;text-align:left">Mode</th><th style="padding:0 8px 6px 0;font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:.04em;color:#8a97a6;text-align:right">Time</th><th style="padding:0 8px 6px 0;font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:.04em;color:#8a97a6;text-align:right">Cost</th></tr><tr><td style="padding:9px 8px 9px 0;border-top:1px solid #eef2f7;font-size:13px;color:#1f2a37">Plot y=sin(x) for x in 0..4pi and show me the picture</td><td style="padding:9px 8px 9px 0;border-top:1px solid #eef2f7;font-size:13px;color:#8a97a6">Deep</td><td style="padding:9px 8px 9px 0;border-top:1px solid #eef2f7;font-size:13px;color:#8a97a6;text-align:right">47s</td><td style="padding:9px 8px 9px 0;border-top:1px solid #eef2f7;font-size:13px;font-weight:600;text-align:right">3.2317 &#8371;</td></tr><tr><td style="padding:9px 8px 9px 0;border-top:1px solid #eef2f7;font-size:13px;color:#1f2a37">Terminal session</td><td style="padding:9px 8px 9px 0;border-top:1px solid #eef2f7;font-size:13px;color:#8a97a6">Thoughtful</td><td style="padding:9px 8px 9px 0;border-top:1px solid #eef2f7;font-size:13px;color:#8a97a6;text-align:right">10m 12s</td><td style="padding:9px 8px 9px 0;border-top:1px solid #eef2f7;font-size:13px;font-weight:600;text-align:right">0.5265 &#8371;</td></tr></table>',
			],
		],
		'signin_code' => [
			'label'    => 'Sign-in code',
		...
		'dm_received' => [
			...
			'body'     => "{{sender}} sent you a message, and it's still unread.\n\nWe can't show it here — ArtaQuest messages are end-to-end encrypted, so only your own device holds the key that opens them. Open ArtaChat to read it.\n\nWe only email you when a message has been sitting unread for a few minutes while you're away — read it first and this never arrives — and at most once every 30 minutes per conversation. To stop these, turn off \"Email me when a message arrives\" in ArtaChat.",
			'cta'      => [ 'Open ArtaChat', '/messages/' ],
			'vars'     => [ 'sender' ],
			'sample'   => [ 'sender' => 'Arash' ],
		],
		/**
