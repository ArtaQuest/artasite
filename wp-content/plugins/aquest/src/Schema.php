...
final class Schema {
	...
	public static function tables() {
		return [
			...
			// `bucket` is the crd_<cty>_<band> fund earmark the money sits
			...
			// nationality and age band beside their user id.
			'aq_credit_grants' => "
				id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
			...
			'aq_cast_requests' => "
				...
				recorded_note VARCHAR(191) NOT NULL DEFAULT '',
				created INT UNSIGNED NOT NULL DEFAULT 0,
				updated INT UNSIGNED NOT NULL DEFAULT 0,
				PRIMARY KEY  (id),
	...
	public static function dictionary() {
		return [
			...
			'aq_cast_requests' => [ 'desc' => 'ArtaCast — a couple\'s request to appear on the show: the facts the episode frame airs (names, one line each, birth, photographs, the year they married, milestones), the partner\'s invitation, and the recording (an ordinary aq_meets row booked from the host\'s published hours).', 'cols' => [ 'status' => 'draft | scheduled | cancelled', 'a_*' => 'the member who asked', 'b_*' => 'their partner', 'a_rows' => 'milestones as [{y, l}] for the timeline', 'invite_token' => 'sha256 of the partner\'s single-use link (masked)', 'b_email' => 'the partner\'s address, typed by their spouse (masked)', 'meet_id' => 'the recording, once booked', 'recorded_at' => 'when the host\'s device finished writing the episode (the file itself never reaches the server — the room is sealed)' ] ],
