...
- **NEW**: Premium ArtaQuest Templates users can now access the Custom Course Pages feature. Use it to build unique, conversion-focused course pages with 50+ Elementor widgets.
...
## 2.0.7 - 2025-01-07
- **FIXED**: Fixed an issue where mobile header in ArtaQuest Templates opened incorrectly on RTL layouts.
...
- **FIXED**: Resolved Customizer settings not applying to Gutenberg blocks in ArtaQuest Templates.
- **FIXED**: Small bug fixes.
...
## 1.0.4 - 2023-09-11
- **FIXED**: When the ArtaQuest Starter theme is active, the question explanation is not displayed when clicking the show answers button in the quiz.
